...
export function ShelfVacancyRate() {
  const MOCK_DATA = [
    { id: '1', whName: '星卓越泰国国仓', zone: '1', shelfName: '1', totalShelves: '1', occupiedShelves: '1', idleShelves: '0', vacancyRate: '0%', dsInventory: '10', transitInventory: '0', status: '显示' },
  ];
  ...
  return (
    <div className="bg-[#f0f2f5] min-h-screen font-sans text-gray-700">
          ...
          <table className="w-full border-collapse text-[12px] text-left">
            <thead className="bg-[#f5f7fa] text-gray-600 font-medium">
              <tr>
                ...
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">区域名称</th>
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">货架名称</th>
                ...
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">空闲货架</th>
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">货架空置率</th>
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">代发库存(个)</th>
                <th className="px-3 border-r border-gray-200 min-w-[100px] py-2">中转库存(箱)</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {MOCK_DATA.map((item, idx) => (
                <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-3 border-r border-gray-200 text-blue-500 cursor-pointer hover:underline py-2">{item.whName}</td>
                  <td className="px-3 border-r border-gray-200 text-blue-500 cursor-pointer hover:underline py-2">{item.zone}</td>
                  <td className="px-3 border-r border-gray-200 text-blue-500 cursor-pointer hover:underline py-2">{item.shelfName}</td>
                  ...
                  <td className="px-3 border-r border-gray-200 py-2">{item.idleShelves}</td>
                  <td className="px-3 border-r border-gray-200 text-red-500 font-bold py-2">{item.vacancyRate}</td>
                  <td className="px-3 border-r border-gray-200 py-2">{item.dsInventory}</td>
                  <td className="px-3 border-r border-gray-200 py-2">{item.transitInventory}</td>
                  ...
                  <td className="px-3 text-blue-500 cursor-pointer py-2 border-r border-gray-200">
                    <span className="hover:underline mx-1">[库存货架]</span>
                  </td>
                </tr>
              ))}
              <tr className="hover:bg-gray-50 transition-colors">
                <td colSpan={4} className="px-3 border-r border-gray-200 font-bold py-2">合计</td>
                <td className="px-3 border-r border-gray-200 font-bold py-2">1</td>
                <td className="px-3 border-r border-gray-200 font-bold py-2">1</td>
                <td className="px-3 border-r border-gray-200 font-bold py-2">0</td>
                <td className="px-3 border-r border-gray-200 text-red-500 font-bold py-2">0%</td>
                <td className="px-3 border-r border-gray-200 font-bold py-2">10</td>
                <td className="px-3 border-r border-gray-200 font-bold py-2">0</td>
      ...
      <div className="mt-8 text-center text-[11px] text-gray-400 pb-10">
         <p>共执行 10 个查询，用时 0.015184 秒，Gzip 已禁用，内存占用 4.531 MB</p>
      </div>
    </div>
  );
}
